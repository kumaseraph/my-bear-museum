      ...
      <nav class="sidebar" id="sidebar" role="navigation" aria-label="主導航">
        ...
        <div class="nav-links">
          <div class="nav-group">
            ...
            <a href="/ppt" class="nav-link"><span class="icon">📊</span>PPT素材</a>
            <a href="/slides" class="nav-link"><span class="icon">🎬</span>熊熊簡報</a>
          ...
          <div class="nav-group">
            ...
            <a href="https://kumaweb.pages.dev/meow" class="nav-link"><span class="icon">🐱</span>喵時光</a>
          </div>
